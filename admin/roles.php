...
$sections = [
    [
        ...
        'color' => 'blue',
        'rows'  => [
            ['label' => 'View patient list',                  'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'View patient profile',               'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Add / edit patients',                'desc' => 'Create new records, update demographics','admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Change patient status',              'desc' => 'Active / Inactive / Discharged',         'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Delete patient records',             'desc' => 'Permanent removal',                      'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'Upload patient photo',               'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => false],
        ],
    ],
    [
        ...
        'color' => 'indigo',
        'rows'  => [
            ['label' => 'Fill out / submit forms',            'desc' => 'All 12 form types',                      'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'View submitted documents',           'desc' => 'Read-only view',                         'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Print / export PDF',                 'desc' => 'Single or bulk export',                  'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Upload documents to portal',         'desc' => 'Mark as Uploaded to PF',                 'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Request e-signature',                'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Delete form submissions',            'desc' => 'Permanent removal',                      'admin' => true,  'ma' => false, 'billing' => false],
        ],
    ],
    [
        'title' => 'Clinical Data',
        ...
        'color' => 'red',
        'rows'  => [
            ['label' => 'View vitals & vital trends',         'desc' => 'BP, weight, O2, pulse, glucose, etc.',   'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'View & manage medications',          'desc' => 'Add, edit, discontinue meds',            'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'View & log wound measurements',      'desc' => 'Wound size, photos, trend chart',        'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Wound photos',                       'desc' => 'Upload and view wound images',           'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Manage diagnoses (ICD-10)',          'desc' => 'Add / remove diagnosis codes',           'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'SOAP notes',                         'desc' => 'Create and edit clinical notes',         'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Care coordination notes',            'desc' => 'Team discussion thread per patient',     'admin' => true,  'ma' => true,  'billing' => false],
        ],
    ],
    [
        ...
        'color' => 'amber',
        'rows'  => [
            ['label' => 'View submitted forms (read-only)',   'desc' => 'For coding reference',                   'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'View ICD-10 diagnoses',              'desc' => 'Diagnosis codes on patient record',      'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Export forms to PDF',                'desc' => 'For billing records',                    'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Add / edit diagnoses',               'desc' => 'Modify clinical data',                   'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'View clinical PHI fields',           'desc' => 'Vitals, meds, wounds, chief complaint',  'admin' => true,  'ma' => true,  'billing' => false],
        ],
    ],
    [
        'title' => 'Communication',
        ...
        'color' => 'teal',
        'rows'  => [
            ['label' => 'Internal messaging',                 'desc' => 'Send/receive staff messages',            'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Receive notifications',              'desc' => 'Bell icon — pending uploads, drafts',    'admin' => true,  'ma' => true,  'billing' => true ],
            ['label' => 'Global search',                      'desc' => 'Search patients and forms (Ctrl+K)',     'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'View patient messages/updates',      'desc' => 'Message thread for billing only',        'admin' => true,  'ma' => true,  'billing' => true ],
        ],
    ],
    [
        'title' => 'Scheduling',
        ...
        'color' => 'violet',
        'rows'  => [
            ['label' => 'View daily schedule',                'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Add / edit visits',                  'desc' => 'Schedule patient home visits',           'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'Manage recurring schedules',         'desc' => 'Set up repeating visit patterns',        'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'Mark visits complete / en-route',   'desc' => '',                                       'admin' => true,  'ma' => true,  'billing' => false],
            ['label' => 'Productivity reports',               'desc' => 'Per-MA visit and form metrics',          'admin' => true,  'ma' => false, 'billing' => false],
        ],
    ],
    [
        ...
        'color' => 'purple',
        'rows'  => [
            ['label' => 'Add / edit staff accounts',          'desc' => 'Create users, change passwords',         'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'Assign / change user roles',         'desc' => '',                                       'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'Enable / disable staff accounts',    'desc' => '',                                       'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'View HIPAA audit log',               'desc' => 'Full access / action trail',             'admin' => true,  'ma' => false, 'billing' => false],
            ['label' => 'System settings',                    'desc' => 'Portal URL, session timeout, etc.',      'admin' => true,  'ma' => false, 'billing' => false],
        ],
    ],
];
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/60 transition-colors">
                    ...
                    <?php foreach (['admin','ma','billing'] as $role): ?>
