...
$releases = [
    [
        ...
        'items'   => [
            ...
            ['icon' => 'bi-pin-angle-fill',           'tag' => 'New',     'tag_color' => 'blue',  'title' => 'Floating Active Visit Chip',                     'desc' => 'While a visit is in progress, a persistent floating chip appears in the top-right corner on every page of the app — showing the patient\'s name and a live pulsing indicator. Clicking it returns directly to the open visit form from anywhere. The chip is draggable and remembers its last position, and disappears automatically when the visit is ended or when already on that form.'],
        ],
    ],
    [
        'version' => 'v3.5',
