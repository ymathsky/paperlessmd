...
<div class="bwc-form">
    ...
    ?>
    <p style="font-size:10.5pt;font-style:italic;text-decoration:underline;font-weight:bold;margin:0 0 4pt;">Step 2: Informant Interview</p>
    ...
    ?>
    <table class="bwc-cog-table" style="margin-bottom:8pt;">
    ...
    <div style="border:1px solid #000;padding:5pt 8pt;margin-bottom:10pt;font-size:9.5pt;">
    ...
    <table style="width:100%;border-collapse:collapse;border:1px solid #000;margin-bottom:6pt;font-size:9.5pt;">
        <thead>
