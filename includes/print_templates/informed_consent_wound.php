<?php
/**
 * Print Template: Informed Consent for Wound Care Treatment (informed_consent_wound)
 * Simple one-page format matching the original BWC paper form exactly.
 */
...
// Use form-supplied name/dob if present (in case edited)
if (!empty($fd['patient_name'])) $ptName = h($fd['patient_name']);
if (!empty($fd['dob']))          $ptDob  = h($fd['dob']);
...
<div class="bwc-form">
    ...
    <!-- Patient / DOB line -->
    <div style="font-size:10pt;margin-bottom:12pt;">
        <strong>Patient Name:</strong>
        <span style="display:inline-block;min-width:180pt;border-bottom:1px solid #000;vertical-align:bottom;padding-bottom:1pt;"><?= $ptName ?></span>
        &nbsp;&nbsp;&nbsp;
        <strong>DOB:</strong>
        <span style="display:inline-block;min-width:80pt;border-bottom:1px solid #000;vertical-align:bottom;padding-bottom:1pt;"><?= $ptDob ?></span>
    </div>

    <!-- Intro -->
    <div style="font-size:9.5pt;line-height:1.55;margin-bottom:8pt;">
        <p style="margin:0 0 5pt;text-align:justify;">Patient/caregiver hereby voluntarily consents to wound care treatment by the provider (MD/NP) of <strong><?= $_coUC ?></strong>. Patient/Caregiver understands that this consent form will be valid and remain in effect as long as the patient remains active and receives services and treatments at <?= $_coUC ?>. A new consent form will be obtained when a patient is discharged and returns for services and treatments. <strong>Patient has the right to give or refuse consent to any proposed service or treatment.</strong></p>
    </div>

    <!-- Numbered Sections -->
    <ol style="font-size:9.5pt;line-height:1.5;margin:0;padding-left:16pt;">
