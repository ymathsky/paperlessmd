...
<div class="bwc-form">
    ...
    <div style="font-size:9.5pt;line-height:1.55;margin-bottom:8pt;">
        <p style="margin:0 0 5pt;text-align:justify;">Patient/caregiver hereby voluntarily consents to wound care treatment by the provider (MD/NP) of <strong>BEYOND WOUND CARE INC.</strong> Patient/Caregiver understands that this consent form will be valid and remain in effect as long as the patient remains active and receives services and treatments at BEYOND WOUND CARE INC. A new consent form will be obtained when a patient is discharged and returns for services and treatments. <strong>Patient has the right to give or refuse consent to any proposed service or treatment.</strong></p>
    </div>
