...
<table style="width:100%;border-collapse:collapse;font-size:8.5pt;margin-bottom:6pt;">
    ...
    <tbody><tr>
        ...
        <td style="padding:3pt 4pt;text-align:center;border:.5pt solid #e2e8f0;"><?= _npp($fd,$vk,'—') ?></td>
        <?php endforeach; ?>
    </tr></tbody>
</table>
...
<p class="npp-body" style="font-weight:bold;margin-bottom:4pt;">G. OPTIONS — Check only one box.</p>
<?php
$abnOpts = [
...
<?php /* ============================================================ */
      /* FORM 4 — INFORMED CONSENT FOR WOUND CARE                     */
      /* ============================================================ */ ?>
<div class="bwc-form npp-doc">
...
<?php /* ============================================================ */
      /* FORM 5 — PHI AUTHORIZATION (IL DHS)                          */
      /* ============================================================ */ ?>
<div class="bwc-form npp-doc">
...
<?php /* ============================================================ */
      /* FORM 6 — PATIENT FUSION PORTAL CONSENT                       */
      /* ============================================================ */ ?>
<div class="bwc-form npp-doc">
