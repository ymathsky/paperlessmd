...
<div class="bwc-form">
    ...
    <div style="font-size:9.5pt;line-height:1.55;margin-bottom:10pt;">
        <p style="margin:0 0 7pt;">By signing this Agreement, you consent to <span style="text-decoration:underline;font-weight:bold;"><?= $_coUC ?></span> (referred to as "Provider"), providing chronic care management services (referred to as "CCM Services") to you as more fully described below.</p>
        ...
        <ul style="margin:0 0 7pt 16pt;padding:0;font-size:9.5pt;">
            ...
            <li>You have the right to stop CCM Services at any time by revoking this Agreement effective at the end of the then-current month. You may revoke this agreement verbally or in writing to <strong><u><?= $_coUC ?></u></strong>. Upon receipt of your revocation, the Provider will give you written confirmation with effective date of revocation.</li>
        </ul>
    </div>
