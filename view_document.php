...
<style>
  ...
  .bwc-header          { display: flex; flex-direction: row; align-items: center; gap: 14pt; margin-bottom: 10pt; border-bottom: 1.5pt solid #000; padding-bottom: 8pt; }
  .bwc-header-logo     { width: 60pt; height: 60pt; object-fit: contain; flex-shrink: 0; }
  .bwc-header-text     { flex: 1; text-align: center; }
