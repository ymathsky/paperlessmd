        ...
        <?php include __DIR__ . '/../includes/form_company_selector.php'; ?>
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-xl p-5 text-sm text-slate-700 space-y-4 leading-relaxed max-h-[480px] overflow-y-auto">
                ...
                <ol class="space-y-3 pl-4 list-decimal">
                    ...
                    <li><strong>Patient Identification and Wound Images:</strong> Patient/caregiver understands and consents that images (digital, film, etc.) may be taken by <span class="co-name-abb-display">BWC</span> of patient's wounds with their surrounding anatomic features. The purpose of these images is to monitor the progress of wound treatment and ensure continuity of care. Patient/caregiver further agrees that their referring physician/NP may receive communications, including these images, regarding patient's treatment plan and results. The images are considered protected health information and will be handled in accordance with federal laws regarding the privacy, security and confidentiality of such information. Patient understands that <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span> will retain ownership rights to these images, but the patient will be allowed access to view or obtain copies according to state and Federal law. Patient waives any and all rights to royalties or other compensation for these images. Images that identify the patient will only be released and/or used outside <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span> (<span class="co-name-abb-display">BWC</span>) upon written authorization from the patient or patient's legal representative.</li>
                    <li><strong>Use and Disclosure of Protected Health Information (PHI):</strong> Patient consents to <span class="co-name-abb-display">BWC</span> use of PHI, results of patient's medical history and physical examination and wound images obtained during the course of patient's wound care treatment and stored in <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span> wound database for purposes of education, and quality assessment. Patient's PHI may be disclosed by <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span> to its affiliated companies, and third parties who have executed a Business Associate Agreement. Disclosure of patient's PHI shall be in compliance with the privacy regulations of the Health Insurance Portability and Accountability Act of 1996 (HIPAA). Patient/caregiver specifically authorizes use and disclosure of patient's PHI by <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span>, its affiliates, and business associates for purposes related to treatment, payment and health care operations. If patient wishes to request a restriction to how his/her PHI may be used or disclosed, patient may send a written request for restriction to <span class="co-name-uc-display">BEYOND WOUND CARE INC.</span>.</li>
